...
Folio's production build invokes these hooks through the lifecycle manager. The
development/watch lifecycle remains a separate milestone. The current
contract is intentionally frozen while the build integration is verified.
